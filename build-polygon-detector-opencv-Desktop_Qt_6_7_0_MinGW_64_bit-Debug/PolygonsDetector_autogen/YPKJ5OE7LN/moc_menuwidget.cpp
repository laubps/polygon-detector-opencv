...
#include "../../../PolygonsDetector/src/ui/menuwidget.h"
...
Q_CONSTINIT const QMetaObject MenuWidget::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSMenuWidgetENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<MenuButton *, std::false_type>
    >,
    nullptr
} };
...
void MenuWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->selectedItemChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 1: _t->onButtonPress((*reinterpret_cast< std::add_pointer_t<MenuButton*>>(_a[1]))); break;
        default: ;
        }
        ...
        case 1:
            ...
            default: *reinterpret_cast<QMetaType *>(_a[0]) = QMetaType(); break;
            case 0:
                *reinterpret_cast<QMetaType *>(_a[0]) = QMetaType::fromType< MenuButton* >(); break;
            }
            break;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &MenuWidget::selectedItemChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MenuWidget::selectedItemChanged(int _t1)
{
